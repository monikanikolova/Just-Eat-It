...
$(document).ready(function () {
    ...
    $("#recipe-input").keypress(function (event) {
        ...
        if (!(inputValue >= 65 && inputValue <= 90) && (inputValue != 32 && inputValue != 0)) {
            ...
            $("#find-recipe").on("click", function (event) {
                ...
                var queryURL = "https://api.edamam.com/search?q=" + recipeInput + "&app_id=12891585&app_key=a979de59e7904901ed4c92cc3cc16bd0&from=0&to=12&";
